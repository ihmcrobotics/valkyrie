...
public class ValkyrieHighLevelControllerParameters implements HighLevelControllerParameters
{
   ...
   private List<GroupParameter<JointAccelerationIntegrationParametersReadOnly>> getJointAccelerationIntegrationParametersForWalking()
   {
      ...
      { // Hip Pitch & Roll joints
         JointAccelerationIntegrationParameters parameters = new JointAccelerationIntegrationParameters();
         parameters.setPositionBreakFrequency(AlphaFilterTools.computeBreakFrequencyGivenAlpha(0.9992, 0.004));
         parameters.setVelocityBreakFrequency(AlphaFilterTools.computeBreakFrequencyGivenAlpha(0.85, 0.004));
         List<String> jointNames = new ArrayList<>();
         for (RobotSide robotSide : RobotSide.values)
      ...
      { // Forearm elbow joint
         JointAccelerationIntegrationParameters parameters = new JointAccelerationIntegrationParameters();
         parameters.setPositionBreakFrequency(AlphaFilterTools.computeBreakFrequencyGivenAlpha(0.9998, 0.004));
         parameters.setVelocityBreakFrequency(AlphaFilterTools.computeBreakFrequencyGivenAlpha(0.84, 0.004));
         parameters.setMaxPositionError(0.2);
         parameters.setMaxVelocityError(2.0);
         List<String> jointNames = new ArrayList<>();
         for (RobotSide robotSide : RobotSide.values)
      ...
      { // Forearm wrist joints
         JointAccelerationIntegrationParameters parameters = new JointAccelerationIntegrationParameters();
         parameters.setPositionBreakFrequency(AlphaFilterTools.computeBreakFrequencyGivenAlpha(0.9995, 0.004));
         parameters.setVelocityBreakFrequency(AlphaFilterTools.computeBreakFrequencyGivenAlpha(0.83, 0.004));
         parameters.setMaxPositionError(0.2);
         parameters.setMaxVelocityError(2.0);
         List<String> jointNames = new ArrayList<>();
         for (RobotSide robotSide : RobotSide.values)
